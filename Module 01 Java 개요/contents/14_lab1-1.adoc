...
----
% java --version
openjdk 17.0.2 2024-01-16 LTS
OpenJDK Runtime Environment Temurin-17.0.2+13 (build 17.0.2+13-LTS)
OpenJDK 64-Bit Server VM Temurin-17.0.2+13 (build 17.0.2+13-LTS, mixed mode)
----
+
